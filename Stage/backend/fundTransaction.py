...
class Transaction():
    ...
    def __init__(self,file):
        ...
        """
        self.file = file
        self.column_name = ['wind_code_s','fof_name','sec_name_s','operating_type','accounting_date','request_date',
    ...
    def checkDfRole(self,df_dict):
        ...
        for i,d in df_dict.items():
            ...
            if d['fof_name'] is not None:
                ...
                if fund is not None :
                    sec_name = db.session.query(FoFModel.sec_name).filter(FoFModel.wind_code==i.wind_code_p).first()
